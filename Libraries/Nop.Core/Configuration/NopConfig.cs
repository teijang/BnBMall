...
namespace Nop.Core.Configuration
{
    ...
    public partial class NopConfig
    {
        ...
        /// <summary>
        /// Gets or sets value of bucket name for image
        /// </summary>
        public string AWSS3ImageBucketName { get; set; }

        /// <summary>
        /// Gets or sets value of aws s3 review image bucket name
        /// </summary>
        public string AWSS3ReviewImageBucketName { get; set; }

        /// <summary>
        /// Gets or sets value of aws s3 review video bucket name
        /// </summary>
        public string AWSS3ReviewVideoBucketName { get; set; }

        /// <summary>
        /// Gets or sets value of awss3 access key id
        /// </summary>
        public string AWSS3AccessKeyId { get; set; }

        /// <summary>
        /// Gets or sets value of aws s3 secret access key
        /// </summary>
        public string AWSS3SecretAccessKey { get; set; }

        /// <summary>
        /// gets or sets value of aws regions
        /// </summary>
        public string AWSS3Region { get; set; }

        /// <summary>
        /// AWS S3 image bucket cdn
        /// </summary>
        public string AWSS3ImageBucketCDN { get; set; }

        /// <summary>
        /// AWS S3 review image bucket cdn
        /// </summary>
        public string AWSS3ReviewImageBucketCDN { get; set; }

        /// <summary>
        /// AWS S3 review video bucket cdn
        /// </summary>
        public string AWSS3ReviewVideoBucketCDN { get; set; }

        /// <summary>
        /// AWS S3 video size
        /// </summary>
        public int AWSS3VideoSize { get; set; }

        /// <summary>
        /// Gets a value indicating whether we should use AWS S3 storage
        /// </summary>
        [JsonIgnore]
        public bool AWSS3StorageEnabled => !string.IsNullOrEmpty(AWSS3AccessKeyId) && !string.IsNullOrEmpty(AWSS3SecretAccessKey);
    }
}