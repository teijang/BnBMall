...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        protected class PlaceOrderContainer
        {
            ...
            /// <summary>
            /// Gets or sets value of check-in date
            /// </summary>
            public string CheckInDate { get; set; }

            /// <summary>
            /// Gets or sets value of checkout date
            /// </summary>
            public string CheckOutDate { get; set; }

            /// <summary>
            /// Gets or sets value of room number
            /// </summary>
            public string RoomNumber { get; set; }

            /// <summary>
            /// Gets or sets value of reservation name
            /// </summary>
        ...
        protected virtual PlaceOrderContainer PreparePlaceOrderDetails(ProcessPaymentRequest processPaymentRequest) {
            ...
            if(_shoppingCartService.ShoppingCartRequiresShipping(details.Cart)) {
                ...
                if(_shippingSettings.AllowPickupInStore && pickupPoint != null) {
                    ...
                    var shippingOptionPoint = _genericAttributeService.GetAttribute<ShippingOption>(details.Customer, NopCustomerDefaults.SelectedShippingOptionAttribute,
                    ...
                    details.PickupAddress = new Address {
                        ...
                        CountryId = country != null ? country.Id : pickupPoint.AddressObject?.CountryId,
                        StateProvinceId = state != null ? state.Id : pickupPoint.AddressObject?.StateProvinceId,
                    ...
                    if(shippingOptionPoint != null) {
                        details.CheckInDate = shippingOptionPoint.CheckInDate;
                        details.CheckOutDate = shippingOptionPoint.CheckOutDate;
                        details.RoomNumber = shippingOptionPoint.RoomNumber;
                        details.ReservationName = shippingOptionPoint.ReservationName;
                    }
                } else {
