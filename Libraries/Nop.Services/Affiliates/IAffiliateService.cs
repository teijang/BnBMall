...
namespace Nop.Services.Affiliates
{
    ...
    public partial interface IAffiliateService
    {
        ...
        void InsertAffiliateType(AffiliateType affiliateType);

        /// <summary>
        /// Updates the affiliate type
        /// </summary>
        /// <param name="affiliate">Affiliate</param>
        void UpdateAffiliateType(AffiliateType affiliateType);
        ...
        /// <param name="affiliateId">Affiliate identifier</param>
        /// <returns>Affiliate</returns>
        AffiliateType GetAffiliateTypeById(int affiliateTypeId);

        /// <summary>
        /// Delete affiliate type
        /// </summary>
        /// <param name="affiliate">Affiliate</param>
        void DeleteAffiliateType(AffiliateType affiliateType);
        ...
        /// <param name="pageSize">page size</param>
        /// <returns></returns>
        IPagedList<AffiliateType> GetAllAffiliateTypes(int pageIndex, int pageSize);
    }
}