...
namespace Nop.Services.Messages
{
    ...
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        public virtual IList<int> SendOrderPlacedStoreOwnerNotification(Order order, int languageId) {
            ...
            var otherEmailAddresses = _emailAccountService.GetAllEmailReceivers(EmailReceiverPermission.Shipping_Manager);
            var adminEmailAddresses = _emailAccountService.GetAllEmailReceivers(EmailReceiverPermission.Administrators);

            IList<string> cc = new List<string>();
            if(order.PaymentStatus == Core.Domain.Payments.PaymentStatus.Paid) {
                if(adminEmailAddresses.Any()) {
                    cc = adminEmailAddresses.Select(x => x.Email).ToList();
                }
            ...
            return messageTemplates.Select(messageTemplate => {
                ...
                return SendNotification(messageTemplate, emailAccount, languageId, tokens, toEmail, toName, cc: cc);
            }).ToList();
        }
        ...
        public virtual IList<int> SendNewReturnRequestStoreOwnerNotification(ReturnRequest returnRequest, OrderItem orderItem, Order order, int languageId) {
            ...
            var otherEmailAddresses = _emailAccountService.GetAllEmailReceivers(EmailReceiverPermission.CS_Manager);
            var adminEmailAddresses = _emailAccountService.GetAllEmailReceivers(EmailReceiverPermission.Administrators);
        ...
        public virtual IList<int> SendNewForumPostMessage(Customer customer, ForumPost forumPost, ForumTopic forumTopic,
            ...
            var otherEmailAddresses = _emailAccountService.GetAllEmailReceivers(EmailReceiverPermission.QA_Manager);
            var adminEmailAddresses = _emailAccountService.GetAllEmailReceivers(EmailReceiverPermission.Administrators);
        ...
        public virtual int SendNotification(MessageTemplate messageTemplate,
            ...
            string fromEmail = null, string fromName = null, string subject = null, IList<string> cc = null) {
            if(messageTemplate == null)
        ...
        /// <summary>
        /// Send new question post message
        /// </summary>
        /// <param name="customer"></param>
        /// <param name="productQA"></param>
        /// <param name="languageId"></param>
        /// <returns></returns>
        public virtual IList<int> SendNewQuestionPostMessage(Customer customer, ProductQA productQA, int languageId) {
            if(customer == null)
                throw new ArgumentNullException(nameof(customer));

            var store = _storeContext.CurrentStore;

            var messageTemplates = GetActiveMessageTemplates(MessageTemplateSystemNames.NewQuestionPostMessage, store.Id);
            if(!messageTemplates.Any())
                return new List<int>();
            ...
            var commonTokens = new List<Token>();
            _messageTokenProvider.AddCustomerTokens(commonTokens, customer);
            _messageTokenProvider.AddProductQATokens(commonTokens, productQA);
