...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        /// <summary>
        /// Add questions tokens
        /// </summary>
        /// <param name="tokens">tokens</param>
        /// <param name="productQA">product QA</param>
        public virtual void AddProductQATokens(IList<Token> tokens, ProductQA productQA) {
            var product = _productService.GetProductById(productQA.ProductId);
            tokens.Add(new Token("ProductQA.Question", productQA.Question));
            tokens.Add(new Token("ProductQA.ProductName", product.Name));

            //event notification
            _eventPublisher.EntityTokensAdded(productQA, tokens);
        }
