...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageProductQuestions = new PermissionRecord { Name = "Admin area. Manage Product Questions", SystemName = "ManageProductQA", Category = "Catalog" };
