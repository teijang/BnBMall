...
namespace Nop.Services.Media
{
    ...
    public partial interface IPictureService
    {
        ...
        /// <param name="defaultPictureType">Default picture type</param>
        /// <returns>Picture URL</returns>
        string GetReviewPictureUrl(int pictureId,
            int targetSize = 0,
            bool showDefaultPicture = true,
            string storeLocation = null,
            PictureType defaultPictureType = PictureType.Entity);
        ...
        /// <param name="virtualPath">Virtual path</param>
        /// <returns>Picture</returns>
        Picture InsertPicture(IFormFile formFile, string defaultFileName = "", string virtualPath = "", bool isReview = false);
        ...
        /// <returns></returns>
        string InsertVideo(IFormFile formFile, string defaultFileName = "", string virtualPath = "");
    }
}