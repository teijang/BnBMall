...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        /// </summary>
        /// <param name="picture">Picture</param>
        protected virtual void DeletePictureThumbs(Picture picture, bool isReview = false) {
        ...
        protected virtual string GetThumbLocalPath(string thumbFileName, bool isReview = false) {
        ...
        /// <param name="storeLocation">Store location URL; null to use determine the current store location automatically</param>
        /// <returns>Local picture thumb path</returns>
        protected virtual string GetThumbUrl(string thumbFileName, string storeLocation = null, bool isReview = false) {
        ...
        /// <returns>Picture binary</returns>
        protected virtual byte[] LoadPictureBinary(Picture picture, bool fromDb, bool isReview = false) {
            if(picture == null)
                throw new ArgumentNullException(nameof(picture));
        ...
        protected virtual bool GeneratedThumbExists(string thumbFilePath, string thumbFileName, bool isReview = false) {
        ...
        protected virtual void SaveThumb(string thumbFilePath, string thumbFileName, string mimeType, byte[] binary, bool isReview = false) {
        ...
        /// <summary>
        /// Load review picture binary
        /// </summary>
        /// <param name="picture"></param>
        /// <returns></returns>
        public virtual byte[] LoadReviewPictureBinary(Picture picture) {
            return LoadPictureBinary(picture, StoreInDb, true);
        }
        ...
        /// <param name="defaultPictureType">Default picture type</param>
        /// <returns>Picture URL</returns>
        public virtual string GetReviewPictureUrl(int pictureId,
            int targetSize = 0,
            bool showDefaultPicture = true,
            string storeLocation = null,
            PictureType defaultPictureType = PictureType.Entity) {
            ...
            if(picture.IsNew) {
                DeletePictureThumbs(picture, true);
                pictureBinary = LoadReviewPictureBinary(picture);
            ...
            var thumbFilePath = GetThumbLocalPath(thumbFileName, true);

            //the named mutex helps to avoid creating the same files in different threads,
            //and does not decrease performance significantly, because the code is blocked only for the specific file.
            using(var mutex = new Mutex(false, thumbFileName)) {
                if(GeneratedThumbExists(thumbFilePath, thumbFileName, true))
                    return GetThumbUrl(thumbFileName, storeLocation, true);
                ...
                if(!GeneratedThumbExists(thumbFilePath, thumbFileName, true)) {
                    ...
                    SaveThumb(thumbFilePath, thumbFileName, picture.MimeType, pictureBinaryResized, true);
                }
        ...
        /// <param name="virtualPath">Virtual path</param>
        /// <returns>Picture</returns>
        public virtual Picture InsertPicture(IFormFile formFile, string defaultFileName = "", string virtualPath = "", bool isReview = false) {
            ...
            var picture = InsertPicture(_downloadService.GetDownloadBits(formFile), contentType, _fileProvider.GetFileNameWithoutExtension(fileName), isReview: isReview);
        ...
        /// <returns></returns>
        public virtual string InsertVideo(IFormFile formFile, string defaultFileName = "", string virtualPath = "") {
            var fileName = formFile.FileName;
            if(string.IsNullOrEmpty(fileName) && !string.IsNullOrEmpty(defaultFileName))
                fileName = defaultFileName;
