    ...
    public partial class OrderModelFactory : IOrderModelFactory
    {
        ...
        protected virtual void PrepareOrderModelShippingInfo(OrderModel model, Order order)
        {
            ...
            else
            {
                ...
                model.PickupAddress.CountryName = pickupCountry?.Name;
                model.PickupAddress.StateProvinceName = _stateProvinceService.GetStateProvinceByAddress(pickupAddress)?.Name;
                PrepareAddressModel(model.PickupAddress, pickupAddress);
