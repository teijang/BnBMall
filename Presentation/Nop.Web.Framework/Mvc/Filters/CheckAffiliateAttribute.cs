...
namespace Nop.Web.Framework.Mvc.Filters
{
    ...
    public sealed class CheckAffiliateAttribute : TypeFilterAttribute
    {
        ...
        private class CheckAffiliateFilter : IActionFilter
        {
            ...
            private const string ROOM_NUMBER_QUERY_PARAMETER_NAME = "room_number";
            ...
            public void OnActionExecuting(ActionExecutingContext context) {
                ...
                //try to find by ID
                var room_number = request.Query[ROOM_NUMBER_QUERY_PARAMETER_NAME];
                if(!string.IsNullOrEmpty(room_number)) {
                    _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, "Room_Number", room_number);
                }
