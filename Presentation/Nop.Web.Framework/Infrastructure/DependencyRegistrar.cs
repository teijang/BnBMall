...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<ProductContentService>().As<IProductContentService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<ProductQAService>().As<IProductQAService>().InstancePerLifetimeScope();

            //register all settings
            builder.RegisterSource(new SettingsSource());

            //picture service
            if(config.AWSS3StorageEnabled)
                builder.RegisterType<AWSS3PictureService>().As<IPictureService>().InstancePerLifetimeScope();
            else if (config.AzureBlobStorageEnabled)
